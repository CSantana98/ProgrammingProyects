...
$respuestaVendedor = ControllerUsers::ctrMostrarUsuarios($itemVendedor, $valorVendedor);
...
<table>
  ...
  <tr>
      ...
      <td style="width:200px">
        <img src="images/logofactura3.png">
      </td>

      <td style="width:115px">
        <div style="font-size:9px; text-align:right; line-height:11px;">
          <br>
          NIT: 71.759.963-9
          <br>
      ...
      <td style="width:135px">
        <div style="font-size:9px; text-align:right; line-height:11px;">
          ...
          <br>
          ventas@technologyisystem.com
        </div>
      </td>

      <td style="width:105px; text-align:center; color:red;"><br><br><b>FACTURA N.</b><br>$valorVenta</td>
