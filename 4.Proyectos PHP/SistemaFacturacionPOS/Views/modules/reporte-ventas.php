...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-line-chart"></i> Reportes de Ventas
    </h1>
    <ol class="breadcrumb">
      <li><a href="homepage"><i class="fa fa-home"></i> Inicio</a></li>
      <li class="active"><i class="fa fa-line-chart"></i> Reportes de Ventas</li>
    </ol>
  </section>
          ...
          <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
              ...
              ?>
                 ...
                 <button class="btn btn-success" style="margin-top:5px"><i class="fa fa-file-excel-o"></i> Descargar reporte en Excel</button>
