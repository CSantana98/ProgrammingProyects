  ...
  $.ajax({
    ...
    success: function(respuesta) {
      ...
      $(".nuevoProducto").append(
          ...
          idProducto + '" name="agregarProducto" value="' +
          ...
          '<input type="text" class="form-control nuevoPrecioProducto" name="nuevoPrecioProducto" precioReal="' +
          precio + '" value="' +
...
$('.tablaVentas').on('draw.dt', function() {
  ...
  if (localStorage.getItem("quitarProducto") != null) {
    ...
    for (var i = 0; i < listaIdProductos.length; i++) {
      $("button.recuperarBoton[idProducto='" + listaIdProductos[i][
        "idProducto"
      ] + "']").removeClass(
        'btn-default');
      $("button.recuperarBoton[idProducto='" + listaIdProductos[i][
      ...
      function funcionForEach(item, index) {
        ...
        if (item.stock != 0) {
          ...
          $("#producto" + numProducto).append(
            '<option idProducto="' + item.id + '" value"' + item.descripcion +
...
$(".formularioVenta").on("change", "select.nuevaDescripcionProducto", function() {
  ...
  var nuevoPrecioProducto = $(this).parent().parent().parent().children(
    ".ingresoPrecio").children().children(".nuevoPrecioProducto");

  var nuevaCantidadProducto = $(this).parent().parent().parent().children(
    ".ingresoCantidad").children(".nuevaCantidadProducto");
  ...
  $.ajax({
    ...
    success: function(respuesta) {
      ...
      $(nuevaCantidadProducto).attr("nuevoStock", Number(respuesta[
        "stock"]) - 1);
      $(nuevoPrecioProducto).val(respuesta["precio_venta"]);
      $(nuevoPrecioProducto).attr("precioReal", respuesta[
        "precio_venta"]);
...
$(".formularioVenta").on("change", "input.nuevaCantidadProducto", function() {
  ...
  var precio = $(this).parent().parent().children(".ingresoPrecio").children()
  ...
  if (Number($(this).val()) > Number($(this).attr("stock"))) {
    ...
    Swal.fire({
      title: "La cantidad que desea agregar supera la cantidad de productos disponibles",
...
$(".formularioVenta").on("change", "input#nuevoValorEfectivo", function() {
  ...
  var nuevoCambioEfectivo = $(this).parent().parent().parent().children(
    '#capturarCambioEfectivo').children().children('#nuevoCambioEfectivo');
...
$(".tablas").on("click", ".btnEliminarVenta", function() {
  ...
  Swal.fire({
    ...
    if (result.value) {
      ...
      window.location = "index.php?ruta=admin-ventas&idVenta=" +
        idVenta;
    }
...
$(".tablas").on("click", ".btnImprimirFactura", function() {
  ...
  window.open("Extensions/tcpdf/examples/factura.php?codigo=" + codigoVenta,
    "_blank");
...
$('#daterange-btn').daterangepicker({
  ...
  function(start, end) {
    ...
    window.location = "index.php?ruta=admin-ventas&fechaInicial=" +
      fechaInicial +
